...
var PARKS=[
 ...
 {level:3,key:"juwangsan",short:"주왕산",name:"주왕산국립공원",image:"assets/characters/03_juwangsan_hq.webp",diameter:.135,color:"#9d7557",area:106.114,score:60},
 ...
 {level:8,key:"eastern",short:"동부지역본부",name:"동부지역본부",image:"assets/characters/08_eastern.png",diameter:.32,color:"#b88b32",area:null,score:1000}
];
var stories=[
["한국에선 흔한 고라니, 세계에선 귀한 동물!","고라니는 세계적으로 IUCN 적색목록의 ‘취약종(VU)’이에요.\n우리에게 흔해도 지구 전체에서 흔한 건 아니랍니다!"],
["기록도, 보관하는 건물도 유네스코 유산!","팔만대장경은 세계기록유산, 보관하는 장경판전은 세계문화유산이에요.\n바람길과 습도를 고려한 건축이 나무 경판을 지켜 왔어요."],
["거대한 절벽의 재료는 화산재!","주왕산의 대표 암석 ‘응회암’은 화산재 등이 쌓여 굳어진 돌이에요.\n조용한 계곡에도 거대한 화산 활동의 흔적이 남아 있답니다!"],
["갓바위는 바위가 아니라 불상 별명!","머리에 갓처럼 넓적한 돌을 얹어 ‘갓바위’라 불러요.\n정식 이름은 ‘경산 팔공산 관봉 석조여래좌상’이랍니다."],
["석굴암은 동굴을 파서 만든 게 아니에요!","화강암을 다듬어 쌓은 인공 석굴이에요.\n둥근 천장까지 돌로 만든 신라인들의 건축 기술이 숨어 있어요."],
["곰의 밥상에는 꿀보다 숲의 열매!","반달가슴곰은 도토리와 산열매 같은 식물성 먹이를 많이 먹어요.\n곤충도 먹는 잡식동물! 꿀단지보다 풍성한 숲이 중요하죠."],
["상괭이를 그릴 땐 등지느러미를 빼주세요!","상괭이는 등지느러미가 없는 해양보호생물이에요.\n폐로 숨 쉬기 때문에 그물에 우연히 잡히는 ‘혼획’을 줄여야 해요."],
["3월 3일은 왜 국립공원의 날일까요?","3월 3일은 우리나라 국립공원 제도의 바탕이 된 「공원법」이 제정된 날이에요.\n이날을 ‘국립공원의 날’로 기념하며 아름다운 자연을 함께 지키자는 의미를 담고 있어요.\n\n오늘 만난 국립공원의 이야기를 오래 기억해 주세요!"]];
...
function afterUpdate(){
  ...
  q.forEach(function(m){
    ...
    if(m.level===7){makeBody(8,x,y,true);finalAchieved=true;beginFinale(m.a,m.b);return}
